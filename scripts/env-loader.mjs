...
export function createClientEnvDefine(publicEnv = getPublicEnv()) {
  const define = {
    ...
    "import.meta.env.MODE": JSON.stringify(process.env.ADAPTIVE_ENV_MODE ?? process.env.NODE_ENV ?? "production"),
    "import.meta.env.DEV": JSON.stringify(process.env.ADAPTIVE_ENV_MODE === "development"),
    "import.meta.env.PROD": JSON.stringify(process.env.ADAPTIVE_ENV_MODE !== "development")
  };
